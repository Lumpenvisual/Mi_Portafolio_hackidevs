    ...
    if (action.href) {
      return (
        <Button
          ...
          nativeButton={false}><span className="flex items-center gap-2">
                          {action.label}
        ...
        <motion.div
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="p-4 space-y-4 pb-32">
              ...
              {/* Preview */}
              <div
                className="relative aspect-[16/9] ring-2 ring-border ring-offset-8 ring-offset-background rounded-lg overflow-hidden">
