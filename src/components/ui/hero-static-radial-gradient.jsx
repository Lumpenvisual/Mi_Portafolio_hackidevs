...
const HeroStaticRadialGradientContext = React.createContext(undefined)
  ...
  return (
    <div
      ...
      <Button
        ...
        nativeButton={false}>{label}</Button>
    </div>
  );
}
...
export function HeroStaticRadialGradientMobileVisual({
  ...
  return (
    <div
      ...
      {...props}>
      <div
        className="absolute inset-x-0 top-0 z-10 h-44 bg-gradient-to-b from-background via-background/90 to-transparent" />
    ...
    <HeroStaticRadialGradientRoot {...props}>
      <HeroStaticRadialGradientContainer className={containerClassName}>
        <HeroStaticRadialGradientContent className={contentClassName}>
          <HeroStaticRadialGradientHeading className={headingWrapClassName} headingClassName={headingClassName} />
